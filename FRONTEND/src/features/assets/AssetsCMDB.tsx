  ...
  return (
    <div className="min-h-full bg-surface-container-lowest p-6 lg:p-8">
      <header className="flex flex-wrap items-start justify-between gap-4">
        ...
        <button type="button" onClick={() => { void sitesQuery.refetch(); void assetsQuery.refetch(); void assetTypesQuery.refetch(); }} className="secondary-button"><RefreshCw className="h-4 w-4" />Sincronizar</button>
      </header>
