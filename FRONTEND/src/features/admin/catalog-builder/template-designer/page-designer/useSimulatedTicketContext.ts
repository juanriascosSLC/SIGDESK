...
const SAMPLE_TICKET: Ticket = {
  ...
  requesterDisplayName: 'Ana Martínez',
  assigneeId: 'sample-assignee',
  assigneeDisplayName: 'Carlos Ruiz',
      ...
      links: [
        {
          ...
          role: 'site',
          snapshot: { displayName: 'Sample site', assetType: 'site', status: 'active' },
        },
        {
          assetId: '00000000-0000-0000-0000-000000000002',
          role: 'affected',
          snapshot: { displayName: 'Camera CAM-0001', assetType: 'camera', manufacturer: 'Hikvision', model: 'DS-2CD', ipAddress: '10.10.1.25', status: 'online' },
        },
      ],
    },
