    ...
    <div>
      <div className="flex items-center gap-3 mb-4">
        ...
        {ticket.priority === 'Critical' && (
          <span className="px-3 py-1 rounded-full bg-status-danger-bg border border-status-danger-border text-xs font-bold text-status-danger-fg tracking-wide uppercase flex items-center gap-1">
