      ...
      {selectedCount > 0 && (
        ...
        >
          ...
          <div className="flex items-center gap-2 pl-4">
            <button 
              onClick={onAssign}
              className="flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-bold text-on-surface-variant hover:text-primary hover:bg-on-surface/5 transition-colors"
            >
            ...
            <button 
              onClick={onResolve}
              className="flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-bold text-on-surface-variant hover:text-status-success-fg hover:bg-on-surface/5 transition-colors"
            >
